    ...
    <div className="col-xl-4 col-md-6">
      <div className="blog-item--three">
        ...
        <div className="blog-item__content">
          ...
          <Link
            href="/nouvelles-et-mise-a-jour/reunion-du-conseille-dadministration"
            className="read-more-two"
          >
            Read More
          </Link>
        </div>
        <ul className="blog-item__meta">
          <li>
            <i className="flaticon-user"></i> <a href="#">BWIMBA</a>
          </li>
          <li className="line"></li>
          <li>
            <i className="flaticon-bubble-chat"></i> <a href="#">0 Comment</a>
          </li>
        </ul>
      </div>
    </div>
