const Nous = () => {
  return (
    <>
      <div className="become-volunteer-video-area pb-65 pt-65 ">
          ...
          <div className="row align-items-center">
            <div className="col-xl-6">
              <div className="become-volunteer-video-content mb-45">
                ...
                <p>
                  Cet ainsi qu&apos;est la mission d&apos;ALARM CONGO vue le jour. Sont
                  but etait d&apos;équiper les dirigeants des églises d&apos;Afrique avec
                  des outils et connaissances pastoraux adéquats pour combler
                  les fléaux qui rongent l&apos;Afrique.
                </p>
              </div>
            </div>
            <div className="col-xl-6">
              <div className="become-volunteer-video overlay mb-55">
                <img src="/assets/img/psa-photo.JPG" alt="Video" />
                <a
